function [rMax, keepChains, rHatByParam] = maxRhatOverMonitoredParams( ...
  chains, monitorParams, minChains, desiredRhat, participantIndices)
...
for p = 1:nPar
  ...
  [rHat, kc] = maxRhatOverParticipants( ...
    chains, minChains, desiredRhat, pname, participantIndices);
